    ...
    GameState.prototype = {
        ...
        create: function () {
            ...
            Voice4Game.init({
               ...
               "white up": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.up;
                  gs.updatePlayer(gs.players.getAt(0));
               },
               "white left": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.left;
                  gs.updatePlayer(gs.players.getAt(0));
               },
               "white right": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.right;
                  gs.updatePlayer(gs.players.getAt(0));
               },
               "black down": function() {
               ...
               "black up": function() {
                  gs.player2.prevDirection = gs.player2.direction = GameState.DIRECTION.up;
                  gs.updatePlayer(gs.players.getAt(1));
               },
               "black left": function() {
                  gs.player2.prevDirection = gs.player2.direction = GameState.DIRECTION.left;
                  gs.updatePlayer(gs.players.getAt(1));
               },
               "black right": function() {
               ...
               "together up": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.up;
                  gs.updatePlayer(gs.players.getAt(0));
                  gs.player2.prevDirection = gs.player2.direction = GameState.DIRECTION.up;
                  gs.updatePlayer(gs.players.getAt(1));
               },
               "together left": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.left;
                  gs.updatePlayer(gs.players.getAt(0));
                  gs.player2.prevDirection = gs.player2.direction = GameState.DIRECTION.left;
                  gs.updatePlayer(gs.players.getAt(1));
               },
               "together right": function() {
                  gs.player1.prevDirection = gs.player1.direction = GameState.DIRECTION.right;
                  gs.updatePlayer(gs.players.getAt(0));
                  gs.player2.prevDirection = gs.player2.direction = GameState.DIRECTION.right;
                  gs.updatePlayer(gs.players.getAt(1));
